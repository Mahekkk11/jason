...
class TopOffersAdapter(var context: Context) :
    RecyclerView.Adapter<TopOffersAdapter.MyHolder>() {

    var objList: ArrayList<CategoryModel> = ArrayList()

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyHolder {
        var myView =
            LayoutInflater.from(parent.context).inflate(R.layout.raw_top_offers, parent, false)
