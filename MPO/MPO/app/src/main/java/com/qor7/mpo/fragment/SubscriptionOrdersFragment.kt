...
import kotlinx.android.synthetic.main.fragment_subscription_orders.view.*

class SubscriptionOrdersFragment : Fragment(),View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        rootView = inflater.inflate(R.layout.fragment_subscription_orders, container, false)

        orderItemAdapter = OrderItemAdapter(requireActivity(), this,2)
    ...
    private fun orderList() {
        ...
        orderItemModel.createdAt = resources.getString(R.string.dummy_date)
        orderItemModel.price = resources.getString(R.string.dummy_price)
        orderItemModel.status = resources.getString(R.string.cancelled)
        orderItemAdapter.objList.add(orderItemModel)
